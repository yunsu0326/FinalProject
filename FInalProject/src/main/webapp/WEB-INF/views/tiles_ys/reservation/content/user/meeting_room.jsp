...
<div id="reservationFormat" style="width:95%; margin: 0 auto;">
	<div class="jumbotron" style="background-color:#e6ffe6;">
	    ...
	    <c:if test="${sessionScope.loginuser.fk_job_id == '3'}">
        	<div class="container" style="text-align: right; margin-top: 20px; cursor:pointer;"><span onclick="goEditContent(1);" ><i class="fa-solid fa-pen"></i>&nbsp;수정하기</span></div>
        </c:if>
	</div>
	...
	<div class="reservation_title" id="reservSelectDate">
		...
		<span style="color:#d9d9d9; font-size:50px; margin-left:50px;">■</span>&nbsp;&nbsp;<span style=" font-size:20px; margin-top:30px; font-weight:bold;"> : 예약불가</span>
	</div> 
