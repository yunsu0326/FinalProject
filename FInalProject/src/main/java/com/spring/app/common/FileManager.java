...
public class FileManager {
    ...
    public String doFileUpload(byte[] bytes, String originalFilename, String path) throws Exception {
    	...
    	newFileName += fileExt;
    	// newFileName 은 예를 들면 (예: 2023112411111535243254235235234.png) 이렇게 된당
    	// 업로드할 경로가 존재하지 않는 경우 폴더를 생성한다.
    	// /Users/sub/workspace_spring_framework/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/board/resources
 	   ...
 	   /*
    	pathname : /Users/sub/workspace_spring_framework/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/board/resources/files/2023112411111535243254235235234.png
	...
	public boolean doFileDownload(String fileName, String originalFilename, String path, HttpServletResponse response) {
		...
		// 예를 들면 pathname : /Users/sub/workspace_spring_framework/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/board/resources/files/2023112411111535243254235235234.png
		try {
		...
		try {
	    	...
	    	// 다운로드할 파일명을 가지고 File 객체를 생성한다.
	    	
	    	if(file.exists()) { // 실제로 다운로드할 해당파일이 있는지 
		...
		return false;
	}// end of 	public boolean doFileDownload(String fileName, String orgFilename, String path, HttpServletResponse response) {
